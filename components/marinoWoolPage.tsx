...
export default function MarinoWoolPage({ products, currentGender, material }: Props) {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-gradient-to-r from-red-900 to-amber-700 text-white rounded-2xl p-12 mb-12 text-center">
        <h1 className="text-5xl font-bold mb-4">Marino Wool</h1>
        <p className="text-xl">Nature's Performance Fabric</p>
        <div className="flex flex-wrap justify-center gap-6 mt-6 text-sm">
          <div className="bg-white/20 px-4 py-2 rounded-full">Breathable</div>
      ...
      {products.length > 0 ? (
        ...
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          <p className="text-red-900">Launching soon !</p>
        </div>
      )}
    </div>
  );
