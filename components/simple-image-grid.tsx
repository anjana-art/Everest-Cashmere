...
const imagesList = [
  { src: "/ladies toupe folded.webp", alt: "Product 1" },
  { src: "/polo yellow fold.webp", alt: "Product 2" },
  { src: "/polo light blue zoom.webp", alt: "Product 3" },
  { src: "/toupe_brunello_zoom.webp", alt: "Product 4" },
];
