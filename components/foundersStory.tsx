// components/FoundersStory.jsx - FULL SEO OPTIMIZED WITH ORIGINAL UI
...
export default function FoundersStory() {
  const schemaData = {
    ...
    "@graph": [
      {
        "@type": "Organization",
        "@id": "https://www.himkash.com/#organization",
        "name": "Himkash",
        "url": "https://www.himkash.com",
        "logo": "https://www.himkash.com/himkash_favicon.png",
        "founder": {
          "@type": "Person",
          "@id": "https://www.himkash.com/#anjana"
        }
      },
      {
        "@type": "Person",
        ...
        "image": "https://www.himkash.com/Anjana_proff_image.webp",
        "worksFor": {
          "@type": "Organization",
          "name": "Himkash"
        },
  ...
  return (
    <>
      {/* Google JSON-LD Schema for Instant Search Visibility */}
      <Script
        id="founder-schema"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-lg text-amber-600 font-medium mt-6">Anjana Bhatta</h2>
        </div>
        ...
        <div className="mb-12 flex justify-center">
          <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden shadow-xl border-4 border-amber-200">
            <Image
              ...
              alt="Anjana Bhatta - Founder and Creator of Himkash"
              fill
