           ...
           <section className=" rounded bg-neutral-100 py-8 items-center sm:py-12 ">
            <div className="mx-auto grid grid-cols-1 items-center justify-items-center gap-8 px-8 sm:px-16  md:grid-cols-2">
               <div className="max-w-md space-y-4">
                ...
                <p  className="text-neutral-600">Discover the timeless elegance with style.Pure Cashmere. handmade with love,  wrapped under the mountain and  direct to  your closet . suppor sustanable , luxury and timeless fashion from Deepanjana. because we care  Enviroment friendly, local artician and your comfort along with style. </p>
